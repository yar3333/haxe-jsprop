...
class TestClass extends BaseClass
{
	...
	{
		super(5);
		trace("TestClass.new: raw this.myPropGetSet = " + Syntax.code("this.myPropGetSet"));
...
class Main
{
	...
	{
		trace("raw klass.myPropGetSet = " + Syntax.code("klass.myPropGetSet"));
		trace("raw klass.myPropGetNever = " + Syntax.code("klass.myPropGetNever"));
